          ...
          <tbody>
            {users.map((user) => (
              <tr key={user.id}>
                ...
                <td>{user.roleId}</td>
                <td>
                  <span className={`role-badge role-${user?.role?.name?.toLowerCase()}`}>{user?.role?.name}</span>
                </td>
                <td>
                ...
                <td>
                  <label className="toggle-switch">
                    <input type="checkbox" checked={/* user.isActive */ true} onChange={() => handleToggleActive(user.id)} />
